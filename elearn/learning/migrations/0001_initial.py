    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Num_of_enrolles_student', models.IntegerField()),
                ('Avarage_review_rating', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Sub_reg', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='learning.registration')),
            ],
        ),
        migrations.CreateModel(
            name='Requests',
            fields=[
                ...
                ('Req_reg', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='learning.registration')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Learn_p_reg', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='learning.registration')),
            ],
        ),
        migrations.CreateModel(
            name='Feedback',
            fields=[
                ...
                ('Feed_reg', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='learning.registration')),
            ],
        ),
        migrations.CreateModel(
            name='Exam_results',
            fields=[
                ...
                ('Exam_res_reg', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='learning.registration')),
            ],
        ),
        migrations.CreateModel(
            name='Exam',
            fields=[
                ...
                ('Exam_reg', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='learning.registration')),
            ],
        ),
        migrations.CreateModel(
            name='Enrollment',
            fields=[
                ...
                ('Enrol_reg', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='learning.registration')),
            ],
        ),
    ]
